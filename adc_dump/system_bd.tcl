...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_IMPORT_BOARD_PRESET {cfg/red_pitaya.xml} CONFIG.PCW_IRQ_F2P_INTR {1} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_USE_S_AXI_HP0 {1}  ] $processing_system7_0
  ...
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins axis_clock_converter_0/M_AXIS] [get_bd_intf_pins axis_packetizer_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_packetizer_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_packetizer_0/M_AXIS]
  ...
  connect_bd_net -net adc_clk_n_1 [get_bd_ports adc_clk_n] [get_bd_pins axis_red_pitaya_adc_0/adc_clk_n]

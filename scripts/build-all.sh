...
zip red-pitaya-ecosystem-0.95-debian-8.6-armhf-$DATE.zip red-pitaya-ecosystem-0.95-debian-8.6-armhf-$DATE.img

make NAME=sdr_transceiver_emb all

sudo sh scripts/image.sh scripts/debian-gnuradio.sh red-pitaya-gnuradio-debian-8.6-armhf-$DATE.img 2048
zip red-pitaya-gnuradio-debian-8.6-armhf-$DATE.zip red-pitaya-gnuradio-debian-8.6-armhf-$DATE.img

make NAME=sdr_transceiver_wspr all

sudo sh scripts/image.sh scripts/debian-wspr.sh red-pitaya-wspr-debian-8.6-armhf-$DATE.img 1024
zip red-pitaya-wspr-debian-8.6-armhf-$DATE.zip red-pitaya-wspr-debian-8.6-armhf-$DATE.img

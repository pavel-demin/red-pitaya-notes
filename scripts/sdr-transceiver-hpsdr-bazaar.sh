...
arm-linux-gnueabihf-gcc -static -O3 -march=armv7-a -mcpu=cortex-a9 -mtune=cortex-a9 projects/$project/server/$server.c -D_GNU_SOURCE -Iprojects/$project/server -lm -lpthread -o $project/$server

...
zip -r red-pitaya-alpine-3.6-armhf-`date +%Y%m%d`-mcpha.zip apks apps boot.bin cache devicetree.dtb modloop red-pitaya.apkovl.tar.gz start.sh uEnv.txt uImage uInitrd wifi

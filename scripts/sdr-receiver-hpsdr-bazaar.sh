project=sdr_receiver_hpsdr
server=sdr-receiver-hpsdr
...
arm-linux-gnueabihf-gcc -static -O3 -march=armv7-a -mcpu=cortex-a9 -mtune=cortex-a9 -mfpu=neon -mfloat-abi=hard projects/$project/server/$server.c -D_GNU_SOURCE -lm -lpthread -o $project/$server

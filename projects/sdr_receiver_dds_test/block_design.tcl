...
cell xilinx.com:ip:xlslice:1.0 slice_6 {
  DIN_WIDTH 160 DIN_FROM 111 DIN_TO 96 DOUT_WIDTH 16
} {
  Din cfg_0/cfg_data
}
...
# Create axis_constant
cell pavel-demin:user:axis_constant:1.0 phase_test {
  AXIS_TDATA_WIDTH 32
} {
...
# Create dds_compiler
cell xilinx.com:ip:dds_compiler:6.0 dds_test {
  DDS_CLOCK_RATE 125
...
# Create cmpy
cell xilinx.com:ip:cmpy:6.0 mult_test {

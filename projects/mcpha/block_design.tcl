...
cell pavel-demin:user:axis_pulse_height_analyzer:1.0 pha_0 {
  ...
  min_data slice_13/Dout
  max_data slice_14/Dout
  aclk ps_0/FCLK_CLK0
...
cell pavel-demin:user:axis_pulse_height_analyzer:1.0 pha_1 {
  ...
  min_data slice_16/Dout
  max_data slice_17/Dout
  aclk ps_0/FCLK_CLK0
...
cell pavel-demin:user:axis_trigger:1.0 trig_0 {
  ...
  pol_data slice_9/Dout
  msk_data const_1/dout
  lvl_data slice_22/Dout
  aclk ps_0/FCLK_CLK0
}

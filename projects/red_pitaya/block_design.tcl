...
connect_bd_net [get_bd_ports S_AXI_HP0_aclk] [get_bd_pins ps_0/S_AXI_HP0_ACLK]
connect_bd_net [get_bd_ports S_AXI_HP1_aclk] [get_bd_pins ps_0/S_AXI_HP1_ACLK]
...
connect_bd_net [get_bd_ports FCLK_CLK0] [get_bd_pins ps_0/FCLK_CLK0]

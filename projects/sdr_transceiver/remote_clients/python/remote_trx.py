...
./remote_trx.py  --address 192.168.188.21 --rate 500000 --freq=14100000 > fillSDA1.raw

Sample use with baudline:
./remote_trx.py  --address 192.168.188.21 --rate 500000 --freq=14100000 | baudline -channels 2 -samplerate 500000 -stdin -quadrature -fftsize 65536 -reset -basefrequency 14100000 -format le32f -scaleby 32767 -flipcomplex

...
class source(gr.hier_block2):
  ...
  rates = {24000:0, 48000:1, 96000:2, 192000:3, 384000:4, 768000:5, 1536000:6, 3072000:7}
  ...
  def set_rate(self, rate):
    if rate in source.rates:
      ...
      raise ValueError("acceptable sample rates are 24k, 48k, 96k, 192k, 384k, 768k, 1536k, 3072k")

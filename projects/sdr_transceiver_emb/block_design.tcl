...
cell xilinx.com:ip:xlslice:1.0 cfg_slice_0 {
  DIN_WIDTH 224 DIN_FROM 159 DIN_TO 32 DOUT_WIDTH 128
} {
  Din cfg_0/cfg_data
}
...
cell xilinx.com:ip:xlslice:1.0 cfg_slice_1 {
  DIN_WIDTH 224 DIN_FROM 223 DIN_TO 160 DOUT_WIDTH 64
} {
  Din cfg_0/cfg_data
}
...
cell xilinx.com:ip:xlconcat:2.1 concat_0 {
  ...
  In5 tx_0/fifo_generator_0/wr_data_count
  In6 not_0/Res
}
...
set_property OFFSET 0x40008000 [get_bd_addr_segs ps_0/Data/SEG_writer_0_reg0]

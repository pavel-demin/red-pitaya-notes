...
cell xilinx.com:ip:xlslice:1.0 cfg_slice_1 {
  DIN_WIDTH 256 DIN_FROM 191 DIN_TO 96 DOUT_WIDTH 96
} {
  Din cfg_0/cfg_data
}
...
cell xilinx.com:ip:xlslice:1.0 cfg_slice_2 {
  DIN_WIDTH 256 DIN_FROM 255 DIN_TO 192 DOUT_WIDTH 64
} {
  Din cfg_0/cfg_data
}
...
for {set i 0} {$i <= 1} {incr i} {
  ...
  set_property OFFSET 0x4000[format %X [expr 2 * $i + 4]]000 [get_bd_addr_segs ps_0/Data/SEG_reader_${i}_reg0]
...
set_property OFFSET 0x40008000 [get_bd_addr_segs ps_0/Data/SEG_writer_0_reg01]
...
set_property OFFSET 0x4000A000 [get_bd_addr_segs ps_0/Data/SEG_writer_1_reg0]
...
set_property OFFSET 0x4000C000 [get_bd_addr_segs ps_0/Data/SEG_writer_0_reg02]
...
set_property OFFSET 0x4000D000 [get_bd_addr_segs ps_0/Data/SEG_reader_1_reg01]
...
set_property OFFSET 0x4000E000 [get_bd_addr_segs ps_0/Data/SEG_writer_0_reg03]
...
set_property OFFSET 0x4000F000 [get_bd_addr_segs ps_0/Data/SEG_reader_0_reg01]

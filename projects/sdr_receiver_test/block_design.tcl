...
cell pavel-demin:user:port_slicer slice_4 {
  DIN_WIDTH 160 DIN_FROM 3 DIN_TO 3
} {
  din cfg_0/cfg_data
}
...
cell pavel-demin:user:port_slicer slice_5 {
  DIN_WIDTH 160 DIN_FROM 61 DIN_TO 32
} {
  din cfg_0/cfg_data
}
...
cell pavel-demin:user:port_slicer slice_8 {
  DIN_WIDTH 160 DIN_FROM 157 DIN_TO 128
} {
  din cfg_0/cfg_data
}

# Create axis_constant
cell pavel-demin:user:axis_constant const_test {
  AXIS_TDATA_WIDTH 32
} {
...
cell xilinx.com:ip:axis_subset_converter subset_test {
...
cell pavel-demin:user:axis_phase_generator phase_test {
  AXIS_TDATA_WIDTH 32
  PHASE_WIDTH 30
} {
...
# Create cordic
cell xilinx.com:ip:cordic cordic_test {
...
cell pavel-demin:user:axis_red_pitaya_dac dac_test {
  DAC_DATA_WIDTH 14
} {
  aclk pll_0/clk_out1

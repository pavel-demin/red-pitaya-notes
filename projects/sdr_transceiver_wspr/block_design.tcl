...
for {set i 0} {$i <= 7} {incr i} {
  ...
  assign_bd_address -range 4K -offset 0x4000[format %X [expr $i + 2]]000 [get_bd_addr_segs -of_objects [get_bd_intf_pins rx_0/reader_$i/S_AXI]]
...
assign_bd_address -range 4K -offset 0x4000A000 [get_bd_addr_segs -of_objects [get_bd_intf_pins tx_0/writer_0/S_AXI]]
...
assign_bd_address -range 4K -offset 0x4000B000 [get_bd_addr_segs -of_objects [get_bd_intf_pins reader_0/S_AXI]]

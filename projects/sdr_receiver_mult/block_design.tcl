...
for {set i 0} {$i <= 5} {incr i} {
  ...
  assign_bd_address -range 8K -offset 0x4000[format %X [expr 2 * $i + 2]]000 [get_bd_addr_segs -of_objects [get_bd_intf_pins rx_0/reader_$i/S_AXI]]

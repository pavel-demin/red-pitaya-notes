  ...
  *rx_addr = size;
  ...
  while(!interrupted)
  {
    ...
    *rx_rate = 16;
    ...
    rx_freq[0] = (uint32_t)floor(10000000 / 125.0e6 * 0xffffffff + 0.5);
    rx_freq[1] = (uint32_t)floor(10000000 / 125.0e6 * 0xffffffff + 0.5);
      ...
      if(size >= 4)
      {
        ...
        switch(command >> 28)
        {
          ...
          case 1:
            ...
            rx_freq[0] = (uint32_t)floor(modf(value / 125.0e6, &integral) * 0xffffffff + 0.5);
            break;
          case 2:
            /* set second phase increment */
            rx_freq[1] = (uint32_t)floor(modf(value / 125.0e6, &integral) * 0xffffffff + 0.5);
            break;
        }
      }

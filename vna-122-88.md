...
-----
 ...
 - Download and unpack the [control program](https://github.com/pavel-demin/red-pitaya-notes/releases/download/20191025/vna-win32-20191025.zip).
...
{% endhighlight %}
 - Download and unpack the [control program](https://github.com/pavel-demin/red-pitaya-notes/releases/download/20191025/vna-python3-20191025.zip).
...
{% highlight bash %}
make NAME=vna_122_88 bit
{% endhighlight %}

Building `vna`:
{% highlight bash %}
arm-linux-gnueabihf-gcc -static -O3 -march=armv7-a -mtune=cortex-a9 -mfpu=neon -mfloat-abi=hard projects/vna_122_88/server/vna.c -o vna -lm -lpthread
{% endhighlight %}
